...
package net.leafenzo.kaleidoscopic.registration;
...
import net.leafenzo.kaleidoscopic.entity.ModBoatEntity;
import net.leafenzo.kaleidoscopic.entity.ModEntityTypes;
import net.leafenzo.kaleidoscopic.item.custom.ModBoatItem;
import net.leafenzo.kaleidoscopic.registries.ModFabricRegistries;
import net.leafenzo.kaleidoscopic.registry.tag.ModTags;
import net.leafenzo.kaleidoscopic.block.ModBlocks;
import net.leafenzo.kaleidoscopic.registries.ModFabricRegistries;
...
import static net.leafenzo.kaleidoscopic.registration.ModRegistryHelper.*;
